...
RUNDACDB := $(DOCKERCOMPOSE) up -d cdk-validium-data-node-db
STOPDACDB := $(DOCKERCOMPOSE) stop cdk-validium-data-node-db && $(DOCKERCOMPOSE) rm -f cdk-validium-data-node-db
