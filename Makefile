...
DOCKERCOMPOSEEXPLORERSMARTCONTRACTVERIFIERL1 := explorer-smart-contract-verifier
DOCKERCOMPOSEEXPLORERVISUALIZERL1 := explorer-visualizer
DOCKERCOMPOSEEXPLORERSIGPROVIDERL1 := explorer-sig-provider
...
RUNEXPLORERSMARTCONTRACTVERIFIERL1 := $(DOCKERCOMPOSE) up -d $(DOCKERCOMPOSEEXPLORERSMARTCONTRACTVERIFIERL1)
RUNEXPLORERVISUALIZERL1 := $(DOCKERCOMPOSE) up -d $(DOCKERCOMPOSEEXPLORERVISUALIZERL1)
RUNEXPLORERSIGPROVIDERL1 := $(DOCKERCOMPOSE) up -d $(DOCKERCOMPOSEEXPLORERSIGPROVIDERL1)
RUNEXPLORERPROXYL1 := PROXIED_FRONT_URL=http://${COMMON_HOST}:81 $(DOCKERCOMPOSE) up -d $(DOCKERCOMPOSEEXPLORERPROXYL1)
...
RUNEXPLORERPROXYL2 := PROXIED_FRONT_URL=http://${COMMON_HOST} BACK_PROXY_PASS=http://cdk-validium-explorer-l2:4000 FRONT_PROXY_PASS=http://explorer-frontend-l2:3000 STATS_PROXY_PASS=http://explorer-stats-l2:8050/ $(DOCKERCOMPOSE) up -d $(DOCKERCOMPOSEEXPLORERPROXYL2)
...
STOPEXPLORERSMARTCONTRACTVERIFIERL1 := $(DOCKERCOMPOSE) stop -d $(DOCKERCOMPOSEEXPLORERSMARTCONTRACTVERIFIERL1) && $(DOCKERCOMPOSE) rm -f $(DOCKERCOMPOSEEXPLORERSMARTCONTRACTVERIFIERL1)
STOPEXPLORERVISUALIZERL1 := $(DOCKERCOMPOSE) stop -d $(DOCKERCOMPOSEEXPLORERVISUALIZERL1) && $(DOCKERCOMPOSE) rm -f $(DOCKERCOMPOSEEXPLORERVISUALIZERL1)
STOPEXPLORERSIGPROVIDERL1 := $(DOCKERCOMPOSE) stop -d $(DOCKERCOMPOSEEXPLORERSIGPROVIDERL1) && $(DOCKERCOMPOSE) rm -f $(DOCKERCOMPOSEEXPLORERSIGPROVIDERL1)
...
STOPEXPLORERSMARTCONTRACTVERIFIERL2 := $(DOCKERCOMPOSE) stop -d $(DOCKERCOMPOSEEXPLORERSMARTCONTRACTVERIFIERL2) && $(DOCKERCOMPOSE) rm -f $(DOCKERCOMPOSEEXPLORERSMARTCONTRACTVERIFIERL2)
STOPEXPLORERVISUALIZERL2 := $(DOCKERCOMPOSE) stop -d $(DOCKERCOMPOSEEXPLORERVISUALIZERL2) && $(DOCKERCOMPOSE) rm -f $(DOCKERCOMPOSEEXPLORERVISUALIZERL2)
STOPEXPLORERSIGPROVIDERL2 := $(DOCKERCOMPOSE) stop -d $(DOCKERCOMPOSEEXPLORERSIGPROVIDERL2) && $(DOCKERCOMPOSE) rm -f $(DOCKERCOMPOSEEXPLORERSIGPROVIDERL2)
...
run-l1-explorer: ## Runs L1 blockscan explorer 
	...
	$(RUNEXPLORERSTATSL1)
	$(RUNEXPLORERSMARTCONTRACTVERIFIERL1)
	$(RUNEXPLORERVISUALIZERL1)
	$(RUNEXPLORERSIGPROVIDERL1)
	$(RUNEXPLORERPROXYL1)
...
stop-explorer: ## Stops the explorer
	...
	$(STOPEXPLORERSTATSL1)
	$(STOPEXPLORERSMARTCONTRACTVERIFIERL1)
	$(STOPEXPLORERVISUALIZERL1)
	$(STOPEXPLORERSIGPROVIDERL1)
	$(STOPEXPLORERPROXYL1)
