...
RUNEXPLORERPROXYL1 := PROXIED_FRONT_URL=http://${COMMON_HOST}:81 BACK_PROXY_PASS=http://explorer-backend-l1:4000 FRONT_PROXY_PASS=http://explorer-frontend-l1:3000 STATS_PROXY_PASS=http://explorer-stats-l1:8050/ $(DOCKERCOMPOSE) up -d $(DOCKERCOMPOSEEXPLORERPROXYL1)
...
RUNEXPLORERPROXYL2 := PROXIED_FRONT_URL=http://${COMMON_HOST} BACK_PROXY_PASS=http://explorer-backend-l2:4000 FRONT_PROXY_PASS=http://explorer-frontend-l2:3000 STATS_PROXY_PASS=http://explorer-stats-l2:8050/ $(DOCKERCOMPOSE) up -d $(DOCKERCOMPOSEEXPLORERPROXYL2)
